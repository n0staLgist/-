...
export const taskCopy: Record<YardTask, { title: string; hint: string; memory: DialogueLine[] }> = {
  swing: {
    ...
    hint: 'Поймай ритм и толкни качелю у жёлтой отметки.',
    memory: [
  ...
  hopscotch: {
    ...
    hint: 'Запомни короткую дорожку и повтори прыжки.',
    memory: [
  ...
  window: {
    title: 'Зажечь свет',
    hint: 'Удерживай свет так, чтобы он не погас и не стал слишком ярким.',
    memory: [
...
export const endingLines: DialogueLine[] = [
  { speaker: 'Штрих', text: 'Почти как раньше.' },
  { speaker: 'Ты', text: 'Нет. Раньше здесь были другие рисунки.' },
  { speaker: 'Штрих', text: 'Ты был.' },
  { speaker: 'Ты', text: 'Не только я. И я их не зачёркивал.' },
  ...
  { speaker: 'Штрих', text: 'Красный остался на следующей странице. Там будет понятнее.' },
  { speaker: 'Ты', text: 'Ты опять не ответил.' },
  { speaker: 'Штрих', text: 'Пойдём?' },
  { text: 'Первый цвет вернулся. Ответ — нет.' },
];
